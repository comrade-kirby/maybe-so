...
var init_layout_5e889349 = __esm({
  ".svelte-kit/output/server/chunks/__layout-5e889349.js"() {
    ...
    Purple = create_ssr_component(($$result, $$props, $$bindings, slots) => {
    ...
    Pink = create_ssr_component(($$result, $$props, $$bindings, slots) => {
    ...
    Background = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let $pinkGradient, $$unsubscribe_pinkGradient;
      let $purpleGradient, $$unsubscribe_purpleGradient;
      let $orangeGradient, $$unsubscribe_orangeGradient;
...
var init_index_da755444 = __esm({
  ".svelte-kit/output/server/chunks/index-da755444.js"() {
    ...
    css$42 = {
      code: "section.svelte-1tg26hg{padding:200px 140px;display:flex;flex-direction:column}span.svelte-1tg26hg{font-family:EditorialNew;font-weight:200;white-space:nowrap}p.svelte-1tg26hg{margin:35px 0 75px}@media screen and (max-width: 650px){section.svelte-1tg26hg{padding:200px 0}}",
      map: null
    };
  ...
  <p class="${"svelte-1tg26hg"}">Think we might be a good fit? Reach out and say hi! Make sure to let us know a bit about yourself, your project, and any timeline or budget you may have in mind. </p>
    ...
    css$32 = {
      code: "h2.svelte-do3cr1{margin:160px 20px 60px}.explanations.svelte-do3cr1{display:flex;flex-direction:row;flex-wrap:wrap;margin:0 -28px -28px 0;box-sizing:border-box}.explanation.svelte-do3cr1{display:flex;flex-direction:column;justify-content:center;flex:46%;border:0.5px solid var(--black);padding:50px 70px;margin:0 28px 28px 0;box-sizing:border-box}h5.svelte-do3cr1{margin-bottom:32px}@media screen and (max-width: 1000px){.explanation.svelte-do3cr1{padding:30px}}",
      map: null
    };
    HowWeDoIt = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      $$result.css.add(css$32);
      return `<section><h2 class="${"svelte-do3cr1"}">HOW WE DO IT</h2>
  <div class="${"explanations svelte-do3cr1"}"><div class="${"explanation svelte-do3cr1"}"><h5 class="${"svelte-do3cr1"}">WE&#39;RE NEVER DONE LEARNING.</h5>
      <p>We\u2019re experts, but every project is different, and technology is ever-changing. That means we approach each project as an opportunity to level-up. If you like our previous work, I bet you we can do better.</p></div>
    <div class="${"explanation svelte-do3cr1"}"><h5 class="${"svelte-do3cr1"}">WE CONSIDER ALL THE OPTIONS.</h5>
      <p>We\u2019re not here to waste anyone\u2019s time chasing after ideas that don\u2019t actually solve the problem. We take the time to think strategically about your unique needs, and then generate options to address them. </p></div>
    <div class="${"explanation svelte-do3cr1"}"><h5 class="${"svelte-do3cr1"}">WE DO WORK LIKE THE BIG AGENCIES, WITHOUT THE BIG PRICE TAGS.</h5>
      <p>We\u2019re resourceful and versatile. We hold ourselves to a high standard and expect our clients to do the same. But we\u2019re also a small, young studio, and that makes us scrappy. That means we can do more to accommodate different budgets. </p></div>
    <div class="${"explanation svelte-do3cr1"}"><h5 class="${"svelte-do3cr1"}">WE&#39;RE WITH YOU EVERY STEP OF THE WAY</h5>
      <p>We make sure you never feel lost in the process. We\u2019re all about communication, and that means breaking our process down and getting your insight and input throughout the project. 
      </p></div></div>
</section>`;
    });
    css$22 = {
      code: "section.svelte-8vtsw5{display:flex;flex-direction:column;justify-content:center;box-sizing:border-box;min-height:95vh}h1.svelte-8vtsw5{margin-bottom:80px}span.svelte-8vtsw5{font-family:EditorialNew;font-weight:200;white-space:nowrap}",
      map: null
    };
    ...
    css$12 = {
      code: "section.svelte-j6qqj1{padding:100px 60px;border-top:0.5px solid var(--black);border-bottom:0.5px solid var(--black)}div.svelte-j6qqj1{display:flex;flex-direction:row;justify-content:flex-start}h4.svelte-j6qqj1{margin:40px 40px 0 0;width:500px}h4.svelte-j6qqj1:hover{text-decoration:underline}span.svelte-j6qqj1{white-space:nowrap}.work-1.svelte-j6qqj1{flex-grow:1}.work-2.svelte-j6qqj1{flex-grow:2}@media screen and (max-width: 650px){section.svelte-j6qqj1{padding:100px 15px}div.svelte-j6qqj1{flex-direction:column;margin-top:-30px}h4.svelte-j6qqj1{width:unset;margin:80px 0 0 0}}",
      map: null
    };
    OurWork = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      $$result.css.add(css$12);
      return `<section class="${"svelte-j6qqj1"}"><h3>Our Work</h3>
	<div class="${"svelte-j6qqj1"}"><h4 class="${"work-1 svelte-j6qqj1"}">A BOLD NEW WEBSITE FOR A VOLUNTEER-RUN LABOR <span class="${"svelte-j6qqj1"}">ORGANIZATION &gt;</span></h4>
    <h4 class="${"work-2 svelte-j6qqj1"}">A HIGHLY EDITORIAL DIGITAL CAMPAIGN TO DISRUPT THE TRADITIONAL PUBLISHING <span class="${"svelte-j6qqj1"}">INDUSTRY  &gt;</span></h4></div>
</section>`;
    });
    css2 = {
      code: "section.svelte-1jfbki2.svelte-1jfbki2{display:flex;flex-direction:column;justify-content:center}h2.svelte-1jfbki2.svelte-1jfbki2{text-align:center;margin:180px 0}h4.svelte-1jfbki2.svelte-1jfbki2{font-weight:400}ul.svelte-1jfbki2.svelte-1jfbki2{margin:0;list-style-type:none;padding:0}div.svelte-1jfbki2.svelte-1jfbki2{display:flex;flex-direction:row;flex-wrap:wrap;max-width:800px;margin:auto;justify-content:center}div.svelte-1jfbki2 h4.svelte-1jfbki2,ul.svelte-1jfbki2.svelte-1jfbki2{box-sizing:border-box;flex:50%;margin-bottom:var(--bottom-margin)}div.svelte-1jfbki2 h4.svelte-1jfbki2:nth-child(odd),ul.svelte-1jfbki2.svelte-1jfbki2:nth-child(odd){text-align:right;padding-right:20px}div.svelte-1jfbki2 h4.svelte-1jfbki2:nth-child(even),ul.svelte-1jfbki2.svelte-1jfbki2:nth-child(even){padding-left:30px}svg.svelte-1jfbki2.svelte-1jfbki2{position:absolute}path.svelte-1jfbki2.svelte-1jfbki2{stroke:var(--black);stroke-width:1px}@media screen and (max-width: 1000px){h2.svelte-1jfbki2.svelte-1jfbki2{margin:160px 0 80px}}@media screen and (max-width: 650px){svg.svelte-1jfbki2.svelte-1jfbki2{display:none}div.svelte-1jfbki2.svelte-1jfbki2{flex-direction:column;max-width:unset;margin:auto}div.svelte-1jfbki2 h4.svelte-1jfbki2,ul.svelte-1jfbki2.svelte-1jfbki2{margin:unset}h4.svelte-1jfbki2.svelte-1jfbki2{padding-bottom:4px}ul.svelte-1jfbki2.svelte-1jfbki2{padding-bottom:60px}div.svelte-1jfbki2 h4.svelte-1jfbki2:nth-child(odd),ul.svelte-1jfbki2.svelte-1jfbki2:nth-child(odd){text-align:center;padding-right:0}div.svelte-1jfbki2 h4.svelte-1jfbki2:nth-child(even),ul.svelte-1jfbki2.svelte-1jfbki2:nth-child(even){text-align:center;padding-left:0}.order-1.svelte-1jfbki2.svelte-1jfbki2{order:1}.order-2.svelte-1jfbki2.svelte-1jfbki2{order:2}.order-3.svelte-1jfbki2.svelte-1jfbki2{order:3}.order-4.svelte-1jfbki2.svelte-1jfbki2{order:4}.order-5.svelte-1jfbki2.svelte-1jfbki2{order:5}.order-6.svelte-1jfbki2.svelte-1jfbki2{order:6}.order-7.svelte-1jfbki2.svelte-1jfbki2{order:7}.order-8.svelte-1jfbki2.svelte-1jfbki2{order:8}.order-9.svelte-1jfbki2.svelte-1jfbki2{order:9}.order-10.svelte-1jfbki2.svelte-1jfbki2{order:10}}",
      map: null
    };
    offeringBottomMargin = 90;
    WhatWeDo = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let h = offeringBottomMargin;
      $$result.css.add(css2);
      return `<section style="${"--bottom-margin: " + escape(offeringBottomMargin) + "px"}" class="${"svelte-1jfbki2"}"><h2 class="${"svelte-1jfbki2"}">WHAT WE DO</h2>
  <div class="${"svelte-1jfbki2"}"><h4 class="${"order-1 svelte-1jfbki2"}">BRAND STRATEGY</h4>
    <ul class="${"order-2 svelte-1jfbki2"}"><li>User Research</li>
      <li>Competitive Analysis</li>
      <li>Experience and Journey Mapping</li>
      <li>User Persona Development</li></ul>
    <ul class="${"order-4 svelte-1jfbki2"}"><li>Visual Branding</li>
      <li>Brand Guides / Style Manuals</li>
      <li>Social Media Collateral</li>
      <li>Block Design / Page Layout</li></ul>
    <h4 class="${"order-3 svelte-1jfbki2"}">GRAPHIC DESIGN</h4>
    <h4 class="${"order-5 svelte-1jfbki2"}">WEB DESIGN</h4>
    <ul class="${"order-6 svelte-1jfbki2"}"><li>Information Architecture &amp; Site Mapping</li>
      <li>UX Writing &amp; Content Design</li>
      <li>Low Fidelity Wireframe Prototypes</li>
      <li>High Fidelity Interactive Prototypes</li></ul>
    <ul class="${"order-8 svelte-1jfbki2"}"><li>Email Campaigns &amp; Newsletters</li>
      <li>Blog Content</li>
      <li>Social Media Campaigns &amp; Content</li></ul>
    <h4 class="${"order-7 svelte-1jfbki2"}">COMMUNICATIONS, MEIDA &amp; MARKETING</h4>
    <h4 class="${"order-9 svelte-1jfbki2"}">DEVELOPMENT</h4>
    <ul class="${"order-10 svelte-1jfbki2"}"><li>Squarespace Development</li>
      <li>Wordpress Development</li>
      <li>Custom Full-Stack Development</li></ul>
    <svg width="${"10"}"${add_attribute("height", h - offeringBottomMargin, 0)} class="${"svelte-1jfbki2"}"><path d="${"M0 0 V " + escape(h - offeringBottomMargin)}" class="${"svelte-1jfbki2"}"></path></svg></div>
</section>`;
    });
    prerender = true;
    Routes = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      return `${$$result.head += `${$$result.title = `<title>Maybe So</title>`, ""}`, ""}

${validate_component(Intro, "Intro").$$render($$result, {}, {}, {})}
${validate_component(OurWork, "OurWork").$$render($$result, {}, {}, {})}
${validate_component(WhatWeDo, "WhatWeDo").$$render($$result, {}, {}, {})}
${validate_component(HowWeDoIt, "HowWeDoIt").$$render($$result, {}, {}, {})}
${validate_component(CanWeHelp, "CanWeHelp").$$render($$result, {}, {}, {})}`;
    });
  }
});
...
${``}`;
    ...
    empty = () => ({});
    manifest = {
      assets: [{ "file": "EditorialNew-Light.otf", "size": 54444, "type": "font/otf" }, { "file": "EditorialNew-Regular.otf", "size": 55368, "type": "font/otf" }, { "file": "EditorialNew-Ultralight.otf", "size": 55028, "type": "font/otf" }, { "file": "Sneak-Bold.otf", "size": 137840, "type": "font/otf" }, { "file": "Sneak-Light.otf", "size": 125180, "type": "font/otf" }, { "file": "Sneak-Regular.otf", "size": 135232, "type": "font/otf" }, { "file": "favicon.png", "size": 1571, "type": "image/png" }, { "file": "robots.txt", "size": 67, "type": "text/plain" }],
